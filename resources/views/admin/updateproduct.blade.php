            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">updateproduct</li>
                  </ol>
                </nav>
            </div>
            {{-- ADD PRODUCT --}}
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-description"> Basic form </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $product["quantity"] }}" class="form-control" id="quantity" name="quantity" placeholder="Product Quantity">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div class="forms-sample">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" placeholder="Product Description" rows="5" style="min-height: 15vh;">{{ $product["description"] }}</textarea>
                                    </div>
                                    {{-- File Upload --}}
                                    <div class="card-body px-0">
                                        <input type="file" name="file" class="dropify form-control" data-default-file="{{ asset('storage/product_imgs/'.$product["image"]) }}" style="background: #2f363d" />
                                    </div>
